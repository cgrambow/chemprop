...
class ReactionDatapoint(Datapoint):
    ...
    def __init__(self,
        ...
        self.rmol = str_to_mol(self.rsmiles, explicit_hydrogens=args.explicit_hydrogens)
        self.pmol = str_to_mol(self.psmiles, explicit_hydrogens=args.explicit_hydrogens)
